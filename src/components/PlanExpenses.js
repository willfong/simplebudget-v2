...
export default function PlanIncome({ expense, planDelete, planAdd, fetchPlan }) {
	...
	const handleAddButton = (e) => {
		e.preventDefault();
		planAdd({ type: "expense", name, amount: parseFloat(amount), currency });
		setName("");
		setAmount("");
		setCurrency("");
		fetchPlan();
	...
	return (
		<div className="bg-white p-4">
			<h2 className="text-base font-semibold leading-7 text-gray-900">Expenses</h2>
